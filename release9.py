...
def pages(g):
    ...
    for task in tasks(g):
        ...
        if project:
            body+='<figure class="task-cover">'+g['img']((project['images'] or [None])[0],project['title'],'../')+'<figcaption><a href="../projects/'+project['id']+'.html">В портфолио: '+e(project['title'])+' ↗</a></figcaption></figure>'
