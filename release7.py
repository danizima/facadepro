...
def compare(g):
 cards=''.join('<label class="compare-choice"><input type="checkbox" value="'+p['id']+'"><span>'+g['img']((p['images'] or [None])[0],p['title'])+'<strong>'+p['title']+'</strong><small>'+p['location']+'</small></span></label>' for p in g['P'])
