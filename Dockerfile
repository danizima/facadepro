...
WORKDIR /app
COPY --chown=node:node package.json server.mjs build.py site_sections.py release4.py visual5.py museum.py release6.py release7.py release8.py release9.py assets9.py ./
