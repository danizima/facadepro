...
css='\n'.join((site/name).read_text() for name in ['styles.css','enhancements.css','business.css','release4.css','visual5.css','museum.css','release6.css','release7.css','vendor/leaflet/leaflet.css'])
app='\n'.join((site/name).read_text() for name in ['vendor/leaflet/leaflet.js','app.js','public.js','request.js','release4.js','visual5.js','museum.js','release6.js','release7.js'])
pages={}
...
rootfiles={'package.json','server.mjs','build.py','site_sections.py','release4.py','visual5.py','museum.py','release6.py','release7.py','requirements.txt','THIRD_PARTY.md','package-preview.py','Dockerfile','compose.yaml','nginx.conf','.dockerignore','.gitignore','.env.example','README.md','DEPLOY.md'}
